    ...
    public partial class LawConnect6 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                // Display the selected ID in a message box
        ...
        private void LawConnect6_Load(object sender, EventArgs e)
        {
